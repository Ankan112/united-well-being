    ...
    return (
        <div className='w-7/12 mx-auto'>
            ...
            <div className='text-center flex justify-center mt-8'>
                <span className=''><img className='w-1/2 bg-white p-2 shadow-md' src={arrowBack} alt="" /></span>
                <span><img className='w-1/2 bg-white p-2 shadow-md' src={arrowForword} alt="" /></span>
            </div>
        </div>
    );
};
