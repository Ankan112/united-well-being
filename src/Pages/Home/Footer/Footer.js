        ...
        <>
                ...
                <div>
                    ...
                    <div className="mt-6 space-y-8 md:mt-8">
                        ...
                        <p className="flex items-start -mx-2">
                            ...
                            <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">+918333552221</span>
                        </p>
                        ...
                        <p className="flex items-start -mx-2">
                            ...
                            <span className="mx-2 text-gray-700 truncate w-72 dark:text-gray-400">sayestagoswami.pt@gmail.com</span>
                        </p>
                    </div>
                </div>
                <div>
            ...
            <footer className="px-10 py-4 border-t bg-base-200 text-base-content border-base-300">
                <div className='flex justify-center items-center'>
                    <h1 className='text-sm'> All Rights Reserved &copy; Sayesta Goswami</h1>
                </div>
            </footer>
        </>
    );
