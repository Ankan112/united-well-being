...
const About = () => {
    return (
        <div>
            ...
            <div style={{ backgroundColor: ' #CEBEBE' }} className="hero  mb-64">
                <div className="w-11/12 mx-auto md:flex">
                    <div className='md:w-1/2'>
                        <img src={aboutImg} alt='' />
                        <div className="flex justify-center items-center mt-8">
                            <Link to='/contact' style={{ backgroundColor: '#E7E6E4' }} className="flex justify-center items-center py-8 px-16 shadow-md btn-xs sm:btn-sm md:btn-md lg:btn-lg">Contact Dr. Goswami</Link>
                        </div>
                    </div>
                    <div className='md:w-1/2'>
