    ...
    return (
        <div className='text-center mt-12'>
            ...
            <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                <div className='w-80 mx-auto bg-slate-300 pb-10 pt-8'>
                    <div className="radial-progress" style={{ "--value": "33", "--size": "4rem", "--thickness": "2px" }}>1</div>
                    <h2 className='py-2 text-sm font-bold'>Choose a Package</h2>
                    <p className='text-sm w-2/3 mx-auto'>Choose between two types of packages, Depending upon on your requirement and need.</p>
                </div>
                <div className='w-80 mx-auto bg-slate-300 pb-10 pt-8'>
                    <div className="radial-progress" style={{ "--value": "66", "--size": "4rem", "--thickness": "2px" }}>2</div>
                    <h2 className='py-2 text-sm font-bold'>Connect With Your Therapist</h2>
                ...
                <div className='w-80 mx-auto bg-slate-300 pb-10 pt-8'>
                    <div className="radial-progress" style={{ "--value": "100", "--size": "4rem", "--thickness": "2px" }}>3</div>
                    <h2 className='py-2 text-sm font-bold'>Begin Your Healing Journey</h2>
